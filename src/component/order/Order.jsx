...
import AddEmp from '../worker/AddEmp';
...
const handleOrderForm=()=>{
  ...
  return (
    <>
    {orderForm?<AddEmp orderForm={orderForm}/> :
      <div className="order container--responsive font--center">
        ...
        {orders.map((order, index) => (
            ...
            <span className='flex flex--justify-content-between flex--align-items-center'>
                <span className='color--maroon fs--22'>{order.customerName}</span>
                <span>
            ...
            <div className='flex flex--justify-content-between flex--align-items-center'>
                ...
                <span className='width--column-60 font--right'>{order.address}</span>
                </span>
        ...
        <button className='bg--maroon bg--radius bg--shadow pd--10 fs--20 width--column-40 color--white mb--20' onClick={handleOrderForm}>Add Order</button>
       </div>
       }
    </>
    )
